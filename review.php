        ...
        <div class="row">
            <div class="box">
                <form action="review.php" method="post" accept-charset="utf-8" >
                  <fieldset><legend>Review This Bakery</legend>
                  <p><label for="rating">Rating</label><input type="radio" name="rating"
                    value="5" class="form-control" /> 5 <input type="radio" name="rating" value="4" class="form-control"/> 4
                    <input type="radio" name="rating" value="3" class="form-control" /> 3 <input type="radio"
                    name="rating" value="2"class="form-control" /> 2 <input type="radio" name="rating" value="1" class="form-control"/> 1</p>
